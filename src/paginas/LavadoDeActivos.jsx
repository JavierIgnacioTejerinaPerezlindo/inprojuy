...
const LavadoDeActivos = () => {
    return (
        ...
        <div className=' container fondotransparente p-5' >
            ...
            <p>
                <p>Acciones a Seguir:</p>
                <ul >
                    <li className='p-1'>Hay que resaltar que este tipo de delitos además de dañar la economía se corre riesgo a nivel mundial que financien acciones terroristas, por ello tanto en Naciones Unidas como en el GAFI ( Grupo de Acción Financiera Internacional)  se volcaron también a introducir como temática la Prevención de Lavado de Activos (LA) y Financiación del Terrorismo ( FT).</li>
                    <li className='p-1'>A través de las pautas o directrices impartidas, se adoptan medidas informativas, en nuestro caso como sujetos obligados, en nuestra Institución, brindando información a la UIF, realizando reportes, teniendo buenas prácticas tanto respecto de los clientes como de las agencias, capacitación al personal del Inprojuy, agencieros y  la información que pueda consultar el cliente para aprender.</li>
...
export default LavadoDeActivos