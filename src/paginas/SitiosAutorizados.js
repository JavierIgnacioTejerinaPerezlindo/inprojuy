...
const SitiosAutorizados = () => {
    return (
        <div className='container fondotransparente p-5'>
            ...
            <p>Los sitios autorizados para la comercialización de juegos de apuestas en Jujuy son:</p>



            <ul><li>VIDEODROME – <a rel="noreferrer noopener" href="http://www.casinosmacgroup.com/" target="_blank">Ir al sitio.</a></li><li>SUPERSTAR</li></ul>



            <ul>
                <li><strong>¿Por qué es importante jugar en sitios autorizados?</strong></li>
